...
y_test_trimmed = y_test[:len(y_pred_lstm)]
evaluate_model(y_test_trimmed, y_pred_lstm.flatten(), "LSTM") # activity : Check the code for LSTM
...
plt.plot(y_test_trimmed.index, y_pred_lstm.flatten(), label="LSTM", linestyle="dashed")
